...
function active(modal){
    ...
    if (doLike.classList.contains('grid__like') && (doLike.classList.contains('grid__like_active') != true)){
...
function closePopup(evt){
    ...
    if (closeBtn.classList.contains('popup__close-image') || closeBtn.classList.contains('form__button')){
